					...
					<div class="profile">
						<div class="profile__user">
							<div class="profile__avatar">
								...
								<img src="{{ Auth::user()->profile ? asset('storage/image/' . Auth::user()->profile) : asset('main/img/avatar.svg') }}" alt="Profile Avatar" id="profile__avatar" >

							</div>
							<div class="profile__meta">
								<h3>{{Auth::user()->name}}</h3>
								<span>FlixTV ID: ST00{{Auth::user()->id}}</span>
							</div>
						</div>
						...
						<ul class="nav nav-tabs profile__tabs" id="profile__tabs" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab" href="#tab-3" role="tab" aria-controls="tab-3" aria-selected="false">Settings</a>
							</li>
						</ul>
						<!-- end tabs nav -->
                    <form class="profile__logout" method="POST" action="{{route('logout')}}">
						@csrf
							...
							<div class="sign__wrap">
								<div class="row">
									...
									<div class="col-12 col-lg-6">
										<form action="{{route('upload-profile')}}" method="POST" class="sign__form sign__form--profile sign__form--first">
											@csrf
											<div class="row">
												<div class="col-12">
									...
									<!-- password form -->
									<div class="col-12 col-lg-6">
										<form action="{{route('update-password')}}" method="POST" class="sign__form sign__form--profile">
											@csrf
											<div class="row">
												<div class="col-12">
            ...
            if (input.files && input.files[0]) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // Optionally, update the src attribute to the uploaded image's URL
