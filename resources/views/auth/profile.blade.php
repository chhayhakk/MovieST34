                ...
                <div class="col-12">
                    <div class="header__content">
                        ...
                        <ul class="header__nav">
                            ...
                            <li class="header__nav-item">
                                <a class="header__nav-link header__nav-link--live" href="live.html">LIVE<svg
                                        width="12" height="12" viewBox="0 0 12 12" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="6" cy="4" r="4" fill="#EB5757"
                                            fill-opacity="0.5" />
                    ...
                    <div class="profile">
                        <div class="profile__user">
                            <div class="profile__avatar">
                                ...
                                <img src="{{ Auth::user()->profile ? asset('storage/image/' . Auth::user()->profile) : asset('main/img/avatar.svg') }}"
                                    alt="Profile Avatar" id="profile__avatar">
