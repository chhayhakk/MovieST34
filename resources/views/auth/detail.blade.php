...
<body>
	...
	<section class="section section--head section--head-fixed section--gradient section--details-bg">
		<div class="section__bg" data-bg="{{asset('storage/image/' . $movie->image_path) }}">
		...
		<div class="container">
			...
			<div class="article">
				<div class="row">
					...
					<!-- video player -->
					<div class="col-12 col-xl-8">
						<video controls crossorigin playsinline poster="{{asset('storage/image/' . $movie->back_photo) }}" id="player" style="height:600px">
							<!-- Video files -->
									...
									<ul class="reviews__list">
										...
										<li class="reviews__item">
											<div class="reviews__autor">
												<img class="reviews__avatar" src="{{asset('storage/image/'. $review->user->profile)}}" alt="">
												<span class="reviews__name">{{$review->title_review}}</span>
												<span class="reviews__time">{{$review->created_at}} by {{$review->users->name}}</span>
									...
									<form action="{{route('movies.review', $movie->id)}}" class="reviews__form" method="POST">
										...
										<div class="row">
											<div class="col-12 col-md-9 col-lg-10 col-xl-9">
												<div class="sign__group">
													<input type="text" name="title" id="title" class="sign__input" placeholder="Title">
												</div>
											</div>
											...
											<div class="col-12">
												<div class="sign__group">
													<textarea name="review" id ="review" class="sign__textarea" placeholder="Add review"></textarea>
												</div>
											</div>
