		...
		<div class="container">
			...
			<div class="article">
				<div class="row">
					...
					<!-- video player -->
					<div class="col-12 col-xl-8">
						<video controls crossorigin playsinline poster="{{asset('storage/image/' . $movie->back_photo) }}" id="player">
							<!-- Video files -->
									...
									<ul class="reviews__list">
										...
										<li class="reviews__item">
											<div class="reviews__autor">
												<img class="reviews__avatar" src="{{asset('storage/image/'. $review->users->profile)}}" alt="">
